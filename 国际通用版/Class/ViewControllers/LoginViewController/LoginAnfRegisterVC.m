...
- (void)setUI{
    ...
    [shangBiaoImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(kScreenW / 1.7, kScreenW / 7.5));
        make.centerX.mas_equalTo(self.view.mas_centerX);
        make.top.mas_equalTo(kNavibarH);
    }];
    
    UILabel *titleLabel = [UILabel creatLableWithTitle:@"智能空气检测仪" andSuperView:self.view andFont:k20 andTextAligment:NSTextAlignmentCenter];
    ...
    [accFiledView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        .offset(kScreenW / 2.67 + kScreenW / 15);
        make.centerX.mas_equalTo(self.view.mas_centerX);
